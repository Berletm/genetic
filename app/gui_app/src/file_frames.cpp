...
{
    NewFrame::NewFrame(wxWindow* parent, wxWindowID id, const wxString& title, 
    ...
    LoadFrame::LoadFrame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style)
    : wxFrame(parent, id, title, pos, size, style)
    {
        this->SetSizeHints(wxDefaultSize, wxDefaultSize);
        wxPanel* panel = new wxPanel(this, wxID_ANY);
        ...
        epoch_ctrl->Bind(wxEVT_TEXT, &LoadFrame::OnNumberInput, this);
        recomb_p_ctrl->Bind(wxEVT_TEXT, &LoadFrame::OnNumberInput, this);
        mutation_p_ctrl->Bind(wxEVT_TEXT, &LoadFrame::OnNumberInput, this);
        epsilon_ctrl->Bind(wxEVT_TEXT, &LoadFrame::OnNumberInput, this);
        compute_btn->Bind(wxEVT_BUTTON, &LoadFrame::OnCompute, this);


        this->Bind(wxEVT_CLOSE_WINDOW, &LoadFrame::OnClose, this);
